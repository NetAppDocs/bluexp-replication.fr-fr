...
summary: Découvrez les nouveautés de la réplication BlueXP. 
---
= Quoi de neuf
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Découvrez les nouveautés de la réplication BlueXP.
...
Nous avons repensé le service de réplication pour qu'il soit facile à utiliser et qu'il corresponde à l'apparence actuelle de l'interface utilisateur.

image:https://raw.githubusercontent.com/NetAppDocs/bluexp-replication/main/media/replication.gif["Capture d'écran de l'onglet réplication reconçue dans Cloud Manager qui affiche la liste des relations de volumes."]
